...
# 3.6.4-alpine-0.16.12

This Dockerfile was generated at 2018-03-20 18:37:13 UTC.

## Tags

`3.6.4-alpine-0.16.12`, `3.6.4-alpine-0.16`, `3.6.4-alpine-async`, `3.6-alpine-0.16.12`, `3.6-alpine-0.16`, `3.6-alpine-async`, `3-alpine-0.16.12`, `3-alpine-0.16`, `3-alpine-async`, `alpine-0.16.12`, `alpine-0.16`, `alpine-async`
...
For example, doing `export DOCKER_UPLOAD_REPOSITORY="example"` would upload to `example/discord.py:3.6.4-alpine-0.16.12`, etc.